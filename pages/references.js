  ...
  return (
    <section className={styler.sec}>
      ...
      <div className={styler.ques}>
        ...
        <Image src="/Home/reference/traveler 1.png" style={{width:"50%",height:"50%"}} className={styler.img} width={1500} height={1500}></Image>
        <h4 className={styler.quesPart} style={{marginTop:"1rem"}}>Sample Input 1</h4>
        <Image src="/Home/reference/traveler 2.png" className={styler.img} width={1500} height={1500}></Image>
      </div>
    </section>
  )
}
