  ...
  return (
    <>
      ...
      <section className={styler.howTo} style={{marginBottom:"0rem"}}>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"  style={{rotate:"180deg",marginTop:"3rem", backgroundImage:"linear-gradient(135deg,rgb(189, 93, 9),rgb(189, 9, 117));"}}><path fill="#ffffff" fill-opacity="1" d="M0,160L40,144C80,128,160,96,240,85.3C320,75,400,85,480,117.3C560,149,640,203,720,224C800,245,880,235,960,213.3C1040,192,1120,160,1200,149.3C1280,139,1360,149,1400,154.7L1440,160L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"></path></svg>
      </section>
      <section className={styler.howTo}  style={{marginTop:"0rem"}}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" style={{backgroundImage:"linear-gradient(45deg, rgb(189, 9, 117),rgb(189, 93, 9));"}}><path className={styler.path} fill='#ffffff' fill-opacity="1" d="M0,160L40,144C80,128,160,96,240,85.3C320,75,400,85,480,117.3C560,149,640,203,720,224C800,245,880,235,960,213.3C1040,192,1120,160,1200,149.3C1280,139,1360,149,1400,154.7L1440,160L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"></path></svg>
